...
//     // Simple serial generator (you can replace with DB counter if needed)
//     const serialNumber = String(client._id).slice(-5).padStart(5, "0");
...
//       companyAddress:
//         "H NO 236 WARD NO 12 PALAUD, NAYA RAIPUR RAIPUR, RAIPUR, CHHATTISGARH, 492101", // ✅ company's address
//       items: [
//         {
